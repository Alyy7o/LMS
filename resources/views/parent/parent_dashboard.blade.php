...
<div class="dashboard-content-one">
    ...
    <div class="breadcrumbs-area">
        ...
        <ul>
            <li>
                <a href="{{url('parent_dashboard')}}">Home</a>
            </li>
            <li>Parents</li>
        </ul>
    </div> 
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="item-content">
                            ...
                            <div class="item-number"><span>$</span><span class="counter" data-num="{{ $amount }}">{{ $amount }}</span></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="item-content">
                            ...
                            <div class="item-number"><span class="counter" data-num="{{ $note }}">{{ $note }}</span></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="item-content">
                            ...
                            <div class="item-number"><span class="counter" data-num="{{ $result }}">{{ $result }}</span></div>
                        </div>
                    </div>
                </div>
            </div>
...
<form action="{{url('admin.add_parent')}}" method="POST">
    ...
    <div class="mb-3">
        ...
        />
        <small id="helpId" class="form-text text-muted">John Dish</small>
    </div>
